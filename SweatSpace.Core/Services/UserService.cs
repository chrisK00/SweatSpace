...
namespace SweatSpace.Core.Services
{
    internal class UserService : IUserService
    {
        ...
        public UserService(IMapper mapper, SignInManager<AppUser> signInManager, ILogger<UserService> logger,
            ITokenService tokenService, IUserRepo userRepo, UserManager<AppUser> userManager, IUserReadRepo userReadRepo)
        {
            _mapper = mapper;
        ...
        {
            return await _userReadRepo.GetMemberResponsesAsync();
        }
